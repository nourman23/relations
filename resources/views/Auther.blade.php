...
<div id="cardsDiv" class="card m-4 d-flex  align-items-center AutherInfo" style="width: 19rem;">
    <div class="card-body">
      <h4 class="card-title">Name : {{$Auther->name}}</h4>
     <p class="card-text">Nationality : {{$Auther->nationality}}</p>
      <p class="card-text descripSec">Email : {{$Auther->email}}</p>
    </div>
  </div>
